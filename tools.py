"""LLM function tools available to the OutboundAI agent.

Nine tools total:
    check_availability, book_appointment, end_call, transfer_to_human,
    send_sms_confirmation, lookup_contact, remember_details,
    book_calcom, cancel_calcom
"""
